    ...
    if not df_propostas.empty:
        ...
        <div class="tabela-container">
            <div class="glass-card fade-in-up" style="border: 1px solid rgba(255, 215, 0, 0.3); border-radius: 10px; overflow: hidden; margin: 10px 0;">
                <h3 style='background: linear-gradient(45deg, #FFD700, #FFA500); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; text-align: center; font-size: 2rem; margin: 15px 0; text-shadow: 0 0 8px rgba(255, 215, 0, 0.3);'>
                    Propostas Diárias
                </h3>
                <table style="width: 100%; border-collapse: collapse; font-size: 1rem; background: #1a1a1a; border-radius: 8px; overflow: hidden; min-width: 800px;">
                <thead>
                    <tr style="border-bottom: 3px solid rgba(255, 215, 0, 0.6); background: #000000;">
                        <th style="font-size: 1.3rem; text-align: left; background: #000000; color: #FFD700; padding: 18px 25px; text-shadow: 0 0 3px rgba(255, 215, 0, 0.3); font-weight: bold; min-width: 200px;">Nome</th>
                        <th style="font-size: 1.3rem; text-align: center; background: #1A1A1A; color: #FFD700; padding: 18px 25px; text-shadow: 0 0 3px rgba(255, 215, 0, 0.3); font-weight: bold; min-width: 300px;">Adquiridas: {int(total_adquiridas)}/90</th>
                        <th style="font-size: 1.3rem; text-align: center; background: #333333; color: #FFD700; padding: 18px 25px; text-shadow: 0 0 3px rgba(255, 215, 0, 0.3); font-weight: bold; min-width: 300px;">Apresentadas: {int(total_apresentadas)}/90</th>
                    </tr>
                </thead>
                <tbody>
        """
        ...
        for i, (_, row) in enumerate(df_propostas.iterrows()):
            ...
            barra1 = f"""
            <div class="progress-bar" style='width: 100%; margin-bottom: 8px; border: 2px solid #FFD700; height: 22px;'>
                <div class="progress-fill" style='width: {proporcao1*100:.1f}%; {cor_barra1} height: 100%; border: 1px solid rgba(255, 215, 0, 0.6);'></div>
            </div>
            <div style='text-align: center;'>
                <span style='font-size: 1.1rem; color: #FFD700; font-weight: bold; text-shadow: 0 0 2px rgba(255, 215, 0, 0.3);'>{valor1}/{maximo}</span>
            </div>
            """
            ...
            <div style='text-align: center;'>
                <span style='font-size: 1.1rem; color: #FFD700; font-weight: bold; text-shadow: 0 0 2px rgba(255, 215, 0, 0.3);'>{valor2}/{maximo}</span>
            </div>
            """
            ...
            <tr style="border-bottom: 1px solid rgba(255, 215, 0, 0.2); background: {bg_color}; transition: background 0.3s ease;">
                <td style="font-size: 1rem; background: #000000; padding: 12px 15px; color: #FFF; vertical-align: middle; text-align: left; text-shadow: 0 0 2px rgba(255, 255, 255, 0.3); font-weight: 500;">
                    {nome} {medalha_html}
                </td>
                <td style="padding: 12px 15px; background: #1A1A1A; color: #FFD700; vertical-align: middle; text-align: center;">
                    {barra1}
                </td>
                <td style="padding: 12px 15px; background: #333333; color: #FFD700; vertical-align: middle; text-align: center;">
                    {barra2}
                </td>
            </tr>
            """
        ...
        """
        st.components.v1.html(tabela_html, height=600, scrolling=True)
    else:

    ...
    if not df_propostas.empty:
        ...
        <div class="tabela-container">
            <div class="glass-card fade-in-up" style="border: 1px solid rgba(255, 215, 0, 0.3); border-radius: 10px; overflow: hidden; margin: 10px 0;">
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem; background: #1a1a1a; border-radius: 8px; overflow: hidden;">
                <thead>
                    <tr style="border-bottom: 2px solid rgba(255, 215, 0, 0.5); background: #000000;">
                        <th style="font-size: 1rem; text-align: left; background: #000000; color: #FFD700; padding: 12px 15px; text-shadow: 0 0 3px rgba(255, 215, 0, 0.3); font-weight: bold;">Nome</th>
                        <th style="font-size: 1rem; text-align: center; background: #1A1A1A; color: #FFD700; padding: 12px 15px; text-shadow: 0 0 3px rgba(255, 215, 0, 0.3); font-weight: bold;">Adquiridas: {int(total_adquiridas)}/90</th>
                        <th style="font-size: 1rem; text-align: center; background: #333333; color: #FFD700; padding: 12px 15px; text-shadow: 0 0 3px rgba(255, 215, 0, 0.3); font-weight: bold;">Apresentadas: {int(total_apresentadas)}/90</th>
                    </tr>
                </thead>
                <tbody>
        """
        ...
        for i, (_, row) in enumerate(df_propostas.iterrows()):
            ...
            barra1 = f"""
            <div class="progress-bar" style='width: 100%; margin-bottom: 6px; border: 2px solid #FFD700;'>
                <div class="progress-fill" style='width: {proporcao1*100:.1f}%; {cor_barra1} height: 100%; border: 1px solid rgba(255, 215, 0, 0.6);'></div>
            </div>
            <div style='text-align: center;'>
                <span style='font-size: 0.9rem; color: #FFD700; font-weight: bold; text-shadow: 0 0 2px rgba(255, 215, 0, 0.3);'>{valor1}/{maximo}</span>
            </div>
            """
            ...
            <div style='text-align: center;'>
                <span style='font-size: 0.9rem; color: #FFD700; font-weight: bold; text-shadow: 0 0 2px rgba(255, 215, 0, 0.3);'>{valor2}/{maximo}</span>
            </div>
            """
